...
variable "acm_certificate_domain" {
  description = "Domain pattern to search in ACM when acm_certificate_arn is not set. Use '*.example.com' to find the wildcard cert that covers api.example.com. Defaults to custom_domain_name when empty."
  type        = string
  default     = ""
}
