...
variable "vpc_name" {
  type        = string
  default     = "data-connections-dev-vpc"
  description = "Name tag of the VPC created by the vpc module."
}

variable "private_subnet_1_name" {
  type        = string
  default     = "data-connections-dev-private-subnet-1"
  description = "Name tag of private-subnet-1 created by the vpc module."
}
