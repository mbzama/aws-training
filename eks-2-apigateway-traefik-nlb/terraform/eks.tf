...
resource "aws_launch_template" "eks_nodes" {
  ...
  # Attach the custom node security group so that the ingress rules defined
  # in security_groups.tf (control-plane → nodes, node-to-node) are applied
  # to the actual EC2 instances.
