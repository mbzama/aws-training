# Redshift Single-Node + PostgreSQL RDS

Single-node Amazon Redshift cluster alongside a PostgreSQL RDS instance. Redshift can reach PostgreSQL on port 5432 via a scoped security group.

Equivalent to CloudFormation template: `redshift-postgres-single-node.yaml`

## What It Creates

- Redshift single-node cluster (ra3.large, encrypted, publicly accessible)
...
| `name_prefix` | `redshift-single` | Prefix for resource names |
