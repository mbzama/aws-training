...
#
# Routes HTTPS traffic arriving at Traefik with Host: <ui_host>
# Flow:
#   GoDaddy CNAME → NLB (TCP 443 passthrough)
#     → Traefik (TLS termination, matches Host header)
#       → mock-web service:80 → pod:3000
# ─────────────────────────────────────────────────────────────────────────────
